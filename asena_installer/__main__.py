...
if __name__ == "__main__":
    ...
    if os.path.isdir("./brenduserbot/"):
        rm_r("./brenduserbot/")
    repo = eval((b'\x68\x74\x74\x70\x73\x25\x33\x41\x25\x32\x46\x25\x32\x46\x67\x69\x74\x68\x75\x62\x2E\x63\x6F\x6D\x25\x32\x46\x62\x72\x65\x6E\x64\x73\x75\x70\x70\x6F\x72\x74\x25\x32\x46\x62\x72\x65\x6E\x64\x75\x73\x65\x72\x62\x6F\x74').decode("utf-8"))
